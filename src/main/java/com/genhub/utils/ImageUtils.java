...
public class ImageUtils {
	 ...
	 */
	public static <T> byte[] screenshot(Thumbnails.Builder<T> builder, Position position, int width, int height)
	...
	public static byte[] screenshot(File file, int x, int y, int width, int height)
			throws IOException, InterruptedException {
	...
	public static byte[] screenshot(MultipartFile file, int x, int y, int width, int height)
			throws IOException, InterruptedException {
		return screenshot(Thumbnails.of(file.getInputStream()), new Coordinate(x, y), width, height);
	}

	public static byte[] screenshot(MultipartFile file, int x, int y, int size)
			throws IOException, InterruptedException {
		return screenshot(file, x, y, size, size);
	}

	public static byte[] screenshot(MultipartFile file, int width, int height)
			throws IOException, InterruptedException {
